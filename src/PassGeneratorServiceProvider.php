...
class PassGeneratorServiceProvider extends ServiceProvider
{
    ...
    private function setupConfig() : void
    {
        ...
        $this->mergeConfigFrom(__DIR__ . '/../config/passgenerator.php', 'passgenerator');

        $this->mergeConfigFrom(__DIR__ . '/../config/pass-filesystem.php', 'filesystems');
    }
    ...
    {
        $this->publishes([
            __DIR__ . '/../config/passgenerator.php' => config_path('passgenerator.php'),
        ], 'config');
    }
}
